...
class OauthAdapterTestCase(unittest.TestCase):
    ...
    def authorize_with_providers(cls, oauth_adapters):
        ...
        state = "abc123"
        authz_responses = {}
        for provider, oauth_adapter in list(oauth_adapters.items()):
    ...
    def test_get_open_id_config(self):
        for provider, oauth_adapter in list(self.oauth_adapters.items()):
    ...
    def test_exchange_authz_code(self):
        ...
        # this test suite
        for provider, authz in list(self.authz_responses.items()):
